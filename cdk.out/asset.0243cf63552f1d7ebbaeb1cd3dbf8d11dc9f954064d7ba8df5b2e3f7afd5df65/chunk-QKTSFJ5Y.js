...
var _CartService = class _CartService {
  constructor() {
    ...
    __privateAdd(this, _cart, void 0);
    __privateSet(this, _cart, signal({}));
    this.cart = __privateGet(this, _cart).asReadonly();
    this.totalInCart = computed(() => {
  ...
  empty() {
    __privateGet(this, _cart).set({});
  }
  updateCount(id, type) {
    const val = this.cart();
    const newVal = __spreadValues({}, val);
    if (!(id in newVal)) {
      newVal[id] = 0;
    }
    if (type === 1) {
      newVal[id] = ++newVal[id];
      __privateGet(this, _cart).set(newVal);
      return;
    }
    if (newVal[id] === 0) {
...
var _c03 = ["addBtn"];
var _CartCountControlsComponent = class _CartCountControlsComponent {
  constructor() {
    this.count = input.required();
    this.available = input.required();
    this.productName = input.required();
    this.increment = output();
    this.decrement = output();
    this.addBtn = viewChild.required("addBtn", {
      read: ElementRef
    });
  }
  focusAddBtn() {
...
_CartCountControlsComponent.\u0275fac = function CartCountControlsComponent_Factory(t) {
  return new (t || _CartCountControlsComponent)();
};
_CartCountControlsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartCountControlsComponent, selectors: [["app-cart-count-controls"]], viewQuery: function CartCountControlsComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx.addBtn, _c03, 5, ElementRef);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance();
  }
}, inputs: { count: [InputFlags.SignalBased, "count"], available: [InputFlags.SignalBased, "available"], productName: [InputFlags.SignalBased, "productName"] }, outputs: { increment: "increment", decrement: "decrement" }, exportAs: ["countControls"], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 6, consts: [["addBtn", ""], ["color", "accent", "mat-icon-button", "", 3, "click", "matTooltip"], ["color", "accent", "mat-icon-button", "", 3, "click", "disabled", "matTooltip"]], template: function CartCountControlsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 1);
    \u0275\u0275listener("click", function CartCountControlsComponent_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.decrement.emit());
    });
    \u0275\u0275elementStart(1, "mat-icon");
    \u0275\u0275text(2, "remove");
    \u0275\u0275elementEnd()();
    \u0275\u0275text(3);
    \u0275\u0275elementStart(4, "button", 2, 0);
    \u0275\u0275listener("click", function CartCountControlsComponent_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.increment.emit());
    });
  ...
  if (rf & 2) {
    \u0275\u0275propertyInterpolate1("matTooltip", "Remove ", ctx.productName(), " from cart");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx.count(), "\n");
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate1("matTooltip", "Add ", ctx.productName(), " to cart");
    \u0275\u0275property("disabled", !!ctx.available() && ctx.count() >= ctx.available());
  }
}, dependencies: [MatIconButton, MatTooltip, MatIcon], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n}\n/*# sourceMappingURL=cart-count-controls.component.css.map */"], changeDetection: 0 });
var CartCountControlsComponent = _CartCountControlsComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CartCountControlsComponent, { className: "CartCountControlsComponent" });
})();
...
//# sourceMappingURL=chunk-QKTSFJ5Y.js.map
