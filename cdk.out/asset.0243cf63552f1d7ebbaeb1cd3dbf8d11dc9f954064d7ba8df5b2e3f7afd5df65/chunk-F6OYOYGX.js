...
var _NotificationService = class _NotificationService {
  constructor() {
    __privateAdd(this, _snackBar, inject(MatSnackBar));
  }
  /**
   ...
   */
  showError(text, duration = 3e3) {
    __privateGet(this, _snackBar).open(text, "Dismiss", {
      duration,
      panelClass: "shop-snackbar-error"
    });
  }
};
_snackBar = new WeakMap();
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-F6OYOYGX.js.map
