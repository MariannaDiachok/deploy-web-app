...
var environment = {
  ...
  apiEndpoints: {
    ...
    bff: "https://56evuqzubf.execute-api.us-east-1.amazonaws.com/prod",
...
var _MatMenuContent = class _MatMenuContent {
  constructor(_template, _componentFactoryResolver, _appRef, _injector2, _viewContainerRef, _document, _changeDetectorRef) {
    this._template = _template;
    this._componentFactoryResolver = _componentFactoryResolver;
    this._appRef = _appRef;
    this._injector = _injector2;
...
var _HeaderComponent = class _HeaderComponent {
  constructor() {
    this.totalInCart = inject(CartService).totalInCart;
  }
};
...
_HeaderComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 16, vars: 2, consts: [["menu", "matMenu"], ["color", "warn"], ["routerLink", "/", "matTooltip", "Open main page", 1, "home-link"], [1, "d-flex", "flex-fill"], ["matTooltip", "Open account menu", "mat-icon-button", "", 3, "matMenuTriggerFor"], ["routerLink", "cart", "matTooltip", "Go to cart", "mat-icon-button", ""], ["matBadgeColor", "accent", 3, "matBadge"], ["routerLink", "admin/orders", "mat-menu-item", ""], ["routerLink", "admin/products", "mat-menu-item", ""]], template: function HeaderComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "div", 3);
    \u0275\u0275elementStart(4, "button", 4)(5, "mat-icon");
    \u0275\u0275text(6, "account_circle");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "button", 5)(8, "mat-icon", 6);
    \u0275\u0275text(9, "shopping_cart");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "mat-menu", null, 0)(12, "a", 7);
    \u0275\u0275text(13, "Manage orders");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "a", 8);
    \u0275\u0275text(15, "Manage products");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const menu_r1 = \u0275\u0275reference(11);
    \u0275\u0275advance(4);
    \u0275\u0275property("matMenuTriggerFor", menu_r1);
    \u0275\u0275advance(4);
    \u0275\u0275property("matBadge", ctx.totalInCart());
  }
}, dependencies: [
  MatToolbar,
  RouterLink,
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "container", "py-3", "py-md-5"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _ErrorPrintInterceptor = class _ErrorPrintInterceptor {
...
_ErrorPrintInterceptor.\u0275fac = function ErrorPrintInterceptor_Factory(t) {
  return new (t || _ErrorPrintInterceptor)(\u0275\u0275inject(NotificationService));
};
_ErrorPrintInterceptor.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ErrorPrintInterceptor, factory: _ErrorPrintInterceptor.\u0275fac });
var ErrorPrintInterceptor = _ErrorPrintInterceptor;

// src/app/products/product-item/product-item.component.ts
var _c03 = ["cartBtn"];
var _c13 = ["controls"];
function ProductItemComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6, 0);
    \u0275\u0275listener("click", function ProductItemComponent_Conditional_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275propertyInterpolate1("matTooltip", "Add ", ctx_r1.product().title, " to cart");
  }
}
function ProductItemComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-cart-count-controls", 7, 1);
    \u0275\u0275listener("increment", function ProductItemComponent_Conditional_14_Template_app_cart_count_controls_increment_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.add());
    })("decrement", function ProductItemComponent_Conditional_14_Template_app_cart_count_controls_decrement_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("productName", ctx_r1.product().title)("count", ctx_r1.countInCart())("available", ctx_r1.product().count);
  }
}
var _injector, _cartService;
var _ProductItemComponent = class _ProductItemComponent {
  constructor() {
    __privateAdd(this, _injector, void 0);
    __privateAdd(this, _cartService, void 0);
    this.product = input.required();
    this.index = input.required();
    this.cartBtn = viewChild("cartBtn", { read: ElementRef });
    this.countControls = viewChild("controls", { read: CartCountControlsComponent });
    __privateSet(this, _injector, inject(Injector));
    __privateSet(this, _cartService, inject(CartService));
    this.countInCart = computed(() => {
      const cart = __privateGet(this, _cartService).cart();
      if (!(this.id in cart)) {
        return 0;
      }
      return cart[this.id];
  ...
  add() {
    __privateGet(this, _cartService).addItem(this.id);
  }
  remove() {
    __privateGet(this, _cartService).removeItem(this.id);
  }
...
_cartService = new WeakMap();
_ProductItemComponent.\u0275fac = function ProductItemComponent_Factory(t) {
  return new (t || _ProductItemComponent)();
};
_ProductItemComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductItemComponent, selectors: [["app-product-item"]], viewQuery: function ProductItemComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx.cartBtn, _c03, 5, ElementRef);
    \u0275\u0275viewQuerySignal(ctx.countControls, _c13, 5, CartCountControlsComponent);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
}, inputs: { product: [InputFlags.SignalBased, "product"], index: [InputFlags.SignalBased, "index"] }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 15, vars: 10, consts: [["cartBtn", ""], ["controls", "countControls"], ["mat-card-image", "", 1, "img-container"], [1, "img-container__inner"], ["alt", "", 3, "src"], ["color", "accent", "mat-icon-button", ""], ["color", "accent", "mat-icon-button", "", 3, "click", "matTooltip"], [3, "increment", "decrement", "productName", "count", "available"]], template: function ProductItemComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card")(1, "div", 2)(2, "div", 3);
    \u0275\u0275element(3, "img", 4);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(13, ProductItemComponent_Conditional_13_Template, 4, 2, "button", 5)(14, ProductItemComponent_Conditional_14_Template, 2, 3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275propertyInterpolate1("src", "https://source.unsplash.com/random?sig=", ctx.index(), "", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx.product().title, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 8, \u0275\u0275pipeBind2(10, 5, ctx.product().price, "1.2-2")));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(13, ctx.countInCart() === 0 ? 13 : 14);
  }
}, dependencies: [
  MatCard,
  MatCardImage,
  ...
  DecimalPipe,
  CurrencyPipe
], styles: ["\n\n.img-container[_ngcontent-%COMP%] {\n  padding-top: 90%;\n  position: relative;\n}\n.img-container__inner[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}\n.img-container[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  object-fit: cover;\n  width: 100%;\n  height: 100%;\n  object-position: center center;\n}\n/*# sourceMappingURL=product-item.component.css.map */"], changeDetection: 0 });
var ProductItemComponent = _ProductItemComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductItemComponent, { className: "ProductItemComponent" });
})();

// src/app/products/products.component.ts
function ProductsComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-product-item", 1);
  }
  if (rf & 2) {
    const product_r1 = ctx.$implicit;
    const $index_r2 = ctx.$index;
    \u0275\u0275property("product", product_r1)("index", $index_r2);
  }
}
var _ProductsComponent = class _ProductsComponent {
  constructor() {
    this.products = toSignal(inject(ProductsService).getProducts(), {
      initialValue: []
    });
  }
};
_ProductsComponent.\u0275fac = function ProductsComponent_Factory(t) {
  return new (t || _ProductsComponent)();
};
_ProductsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductsComponent, selectors: [["app-products"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "container"], [3, "product", "index"]], template: function ProductsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "main", 0);
    \u0275\u0275repeaterCreate(1, ProductsComponent_For_2_Template, 1, 2, "app-product-item", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
}, dependencies: [ProductItemComponent], styles: ["\n\n.container[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr;\n  grid-gap: 30px;\n}\n@media (min-width: 768px) {\n  .container[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr;\n  }\n}\n@media (min-width: 992px) {\n  .container[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr 1fr;\n  }\n}\n/*# sourceMappingURL=products.component.css.map */"], changeDetection: 0 });
var ProductsComponent = _ProductsComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductsComponent, { className: "ProductsComponent" });
})();
...
var appRoutes = [
  ...
  {
    path: "cart",
    loadChildren: () => import("./cart-routes-PBPVLTML.js")
  },
  {
    path: "admin",
    loadChildren: () => import("./admin-routes-NTROFOVX.js")
  }
];
